...
const Login = () => {
  ...
  // 🆕 Nuevo hook de Clerk (unificado para todos los proveedores)
  const { startSSOFlow } = useSSO();

  // 🔄 Lógica unificada para cualquier proveedor OAuth
    ...
    async (strategy: Strategy) => {
      try {
        ...
        if (createdSessionId) {
          ...
          console.warn(`⚠️ No se creó la sesión con ${strategy}`);
        }
      } catch (err) {
